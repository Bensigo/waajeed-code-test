...
var initStore = function initStore(makeStore, initialState, ctx, config) {
  var req = ctx.req;
  var isServer = !!req || typeof window === 'undefined';
  var storeKey = config.storeKey;
  var options = (0, _objectSpread2.default)({}, ctx, config, {
    isServer: isServer
...
var _default = function _default(createStore) {
  ...
  return function (App) {
    ...
    /*#__PURE__*/
    function (_BaseApp) {
      (0, _inherits2.default)(WrappedApp, _BaseApp);

      function WrappedApp() {
        (0, _classCallCheck2.default)(this, WrappedApp);
        return (0, _possibleConstructorReturn2.default)(this, (WrappedApp.__proto__ || (0, _getPrototypeOf.default)(WrappedApp)).apply(this, arguments));
      }
      ...
      (0, _createClass2.default)(WrappedApp, [{
        ...
        value: function render() {
          var _props = this.props,
              ...
              props = (0, _objectWithoutProperties2.default)(_props, ["initialState", "initialProps", "store", "isServer"]);
          var hasStore = store && 'dispatch' in store && 'getState' in store;
          store = hasStore ? store : initStore(createStore, config.deserializeState(initialState), {}, config); // client case, no store but has initialState

          if (config.debug) console.log('4. WrappedApp.render', hasStore ? 'picked up existing one,' : 'created new store with', 'initialState', initialState); // <Container> must be on top of hierarchy for HMR to work
          ...
          return _react.default.createElement(_app.Container, null, _react.default.createElement(_reactRedux.Provider, {
            store: store
          }, _react.default.createElement(App, (0, _extends2.default)({}, initialProps, props, {
            store: store,
            isServer: isServer
          }))));
        }
      ...
      return WrappedApp;
    }(_app.default), Object.defineProperty(_class, "displayName", {
      configurable: true,
      enumerable: true,
      writable: true,
          ...
          return _regenerator.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  appCtx = _args.length > 0 && _args[0] !== undefined ? _args[0] : {};
                  _appCtx$ctx = appCtx.ctx;
                  _appCtx$ctx = _appCtx$ctx === void 0 ? {} : _appCtx$ctx;
                  req = _appCtx$ctx.req, _appCtx$ctx2 = appCtx.ctx, ctx = _appCtx$ctx2 === void 0 ? {} : _appCtx$ctx2;
                  isServer = !!req;
                  store = initStore(createStore, undefined
                  /** initialState **/
                  , ctx, config);
                  ...
                  _context.next = 10;
                  return App.getInitialProps.call(App, (0, _objectSpread2.default)({}, appCtx, {
                    ctx: (0, _objectSpread2.default)({}, ctx, {
                      store: store,
                      isServer: isServer
                    })
                  }));
...
var _default = __WEBPACK_IMPORTED_MODULE_2_next_redux_wrapper___default()(__WEBPACK_IMPORTED_MODULE_3__src_store__["a" /* makeStore */])(myApp);
...
(function () {
  ...
  reactHotLoader.register(myApp, "myApp", "/Users/sigo/Desktop/developer/dev-space/test/waajed-code-test/pages/_app.js");
  reactHotLoader.register(_default, "default", "/Users/sigo/Desktop/developer/dev-space/test/waajed-code-test/pages/_app.js");
  leaveModule(module);
})();
