...
Object(__WEBPACK_IMPORTED_MODULE_1__firebase__["a" /* auth */])().c; // create new user

function createUser(email, password) {
  return __WEBPACK_IMPORTED_MODULE_1__firebase__["a" /* auth */].createUserWithEmailAndPassword(email, password);
} // login user 


function login(email, password) {
  return __WEBPACK_IMPORTED_MODULE_1__firebase__["a" /* auth */].signInWithEmailAndPassword(email, password);
} // logout user


function logout() {
  return __WEBPACK_IMPORTED_MODULE_1__firebase__["a" /* auth */].signOut();
} // password reset 


function resetPassword(email) {
  return __WEBPACK_IMPORTED_MODULE_1__firebase__["a" /* auth */].sendPasswordResetEmail(email);
}
...
//# sourceMappingURL=1.2b39e2bfd1b333c7eb72.hot-update.js.map